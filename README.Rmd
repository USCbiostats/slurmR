...
[![CRAN status](https://www.r-pkg.org/badges/version/sluRm)](https://CRAN.R-project.org/package=sluRm)
...
# slurrm: A Lightweight Wrapper for Slurm <img src="man/figures/logo.png" height="180px" align="right"/>

Slurm Workload Manager is a popular HPC cluster job scheduler found in many of the top 500 super computers. The `slurrm` R package provides an R wrapper to it that matches the parallel package's syntax, this is, just like `parallel` provides the `parLapply`, `clusterMap`, `parSapply`, etc., `slurrm` provides `Slurm_lapply`, `Slurm_Map`, `Slurm_sapply`, etc.
...
job <- Slurm_EvalQ(slurrm::WhoAmI(), njobs = 20, plan = "submit")
...
## Example 3: Using slurrm and future/doParallel/boot/... 
...
`slurrm` with other R packages that support working with `SOCKcluster` class 
...
<table cellspacing="0" border="0">
	...
	<tr>
		<td colspan="8" height="17" align="left" valign="middle" bgcolor="#FFFFFF">[3] Number of directed/recursive dependencies. As reported in <a href="https://tinyverse.netlify.com">https://tinyverse.netlify.com/</a> (June 4th, 2019)</td>
		</tr>
</tbody></table>

## Contributing

We welcome contributions to `slurrm`. Whether it is reporting a bug, starting a discussion by asking a question, or proposing/requesting a new feature, please go by creating a new issue [here](https://github.com/USCbiostats/sluRm/issues) so that we can talk about it.
