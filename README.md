...
#  sbatch --job-name=slurmr-job-2a7c4188e2fc /home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/01-bash.sh
...
ans <- Slurm_lapply(x, mean, plan = "none")
#  --------------------------------------------------------------------------------
#  [VERBOSE MODE ON] The R script that will be used is located at: /home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/00-rscript.r and has the following contents:
#  --------------------------------------------------------------------------------
...
#  JOB_NAME  <- "slurmr-job-2a7c4188e2fc"
...
#  tryCatch_and_quit(INDICES          <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/INDICES.rds"))
#  tryCatch_and_quit(X                <- readRDS(sprintf("/home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/X_%04d.rds", ARRAY_ID)))
#  tryCatch_and_quit(FUN              <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/FUN.rds"))
#  tryCatch_and_quit(mc.cores         <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/mc.cores.rds"))
#  tryCatch_and_quit(seeds            <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/seeds.rds"))
...
#      mc.cores         = mc.cores
#  )
#  saveRDS(ans, sprintf("/home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
#  --------------------------------------------------------------------------------
#  The bash file that will be used is located at: /home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/01-bash.sh and has the following contents:
#  --------------------------------------------------------------------------------
#  #!/bin/sh
#  #SBATCH --job-name=slurmr-job-2a7c4188e2fc
#  #SBATCH --output=/home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/02-output-%A-%a.out
#  #SBATCH --array=1-2
#  #SBATCH --job-name=slurmr-job-2a7c4188e2fc
#  #SBATCH --cpus-per-task=1
#  #SBATCH --ntasks=1
#  export OMP_NUM_THREADS=1
#  /usr/lib/R/bin/Rscript  /home/george/Documents/development/slurmR/slurmr-job-2a7c4188e2fc/00-rscript.r
#  --------------------------------------------------------------------------------
#  EOF
#  --------------------------------------------------------------------------------
#  Warning: [submit = FALSE] The job hasn't been submitted yet. Use sbatch() to submit the job, or you can submit it via command line using the following:
