...
#  sbatch --job-name=slurmr-job-2e2574526e83 /home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/01-bash.sh
...
ans <- Slurm_lapply(x, mean, plan = "none")
#  --------------------------------------------------------------------------------
#  [VERBOSE MODE ON] The R script that will be used is located at: /home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/00-rscript.r and has the following contents:
#  --------------------------------------------------------------------------------
...
#  JOB_NAME  <- "slurmr-job-2e2574526e83"
...
#  tryCatch_and_quit({
#    INDICES          <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/INDICES.rds")
#  })
#  tryCatch_and_quit({
#    X                <- readRDS(sprintf("/home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/X_%04d.rds", ARRAY_ID))
#  })
#  tryCatch_and_quit({
#    FUN              <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/FUN.rds")
#  })
#  tryCatch_and_quit({
#    mc.cores         <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/mc.cores.rds")
#  })
#  tryCatch_and_quit({
#    seeds            <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/seeds.rds")
#  })
...
#  )
#  })
#  saveRDS(ans, sprintf("/home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
#  --------------------------------------------------------------------------------
#  The bash file that will be used is located at: /home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/01-bash.sh and has the following contents:
#  --------------------------------------------------------------------------------
#  #!/bin/sh
#  #SBATCH --job-name=slurmr-job-2e2574526e83
#  #SBATCH --output=/home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/02-output-%A-%a.out
#  #SBATCH --array=1-2
#  #SBATCH --job-name=slurmr-job-2e2574526e83
#  #SBATCH --cpus-per-task=1
#  #SBATCH --ntasks=1
#  export OMP_NUM_THREADS=1
#  /usr/lib/R/bin/Rscript  /home/george/Documents/development/slurmR/slurmr-job-2e2574526e83/00-rscript.r
#  --------------------------------------------------------------------------------
#  EOF
#  --------------------------------------------------------------------------------
#  Warning: [submit = FALSE] The job hasn't been submitted yet. Use sbatch() to submit the job, or you can submit it via command line using the following:
