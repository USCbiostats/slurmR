...
#  sbatch --job-name=slurmR-job-3d813e602257 /home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/01-bash.sh
...
ans <- Slurm_lapply(x, mean, plan = "none")
#  --------------------------------------------------------------------------------
#  [VERBOSE MODE ON] The R script that will be used is located at: /home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/00-rscript.r and has the following contents:
#  --------------------------------------------------------------------------------
...
#  JOB_PATH         <- "/home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/"
#  INDICES          <- readRDS("/home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/INDICES.rds")
#  X                <- readRDS(sprintf("/home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/X_%04d.rds", ARRAY_ID))
#  FUN              <- readRDS("/home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/FUN.rds")
#  mc.cores         <- readRDS("/home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/mc.cores.rds")
#  seeds            <- readRDS("/home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/seeds.rds")
...
#      mc.cores         = mc.cores
#  )
#  saveRDS(ans, sprintf("/home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
#  --------------------------------------------------------------------------------
#  The bash file that will be used is located at: /home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/01-bash.sh and has the following contents:
#  --------------------------------------------------------------------------------
#  #!/bin/sh
#  #SBATCH --job-name=slurmR-job-3d813e602257
#  #SBATCH --output=/home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/02-output-%A-%a.out
#  #SBATCH --array=1-2
#  #SBATCH --ntasks=1
#  #SBATCH --cpus-per-task=1
#  export OMP_NUM_THREADS=1
#  /usr/lib/R/bin/Rscript --vanilla /home/vegayon/Documents/slurmR/slurmR-job-3d813e602257/00-rscript.r
#  --------------------------------------------------------------------------------
#  EOF
#  --------------------------------------------------------------------------------
#  Warning: [submit = FALSE] The job hasn't been submitted yet. Use sbatch() to submit the job, or you can submit it via command line using the following:
