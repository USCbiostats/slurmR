...
[![DOI](http://joss.theoj.org/papers/10.21105/joss.01493/status.svg)](https://doi.org/10.21105/joss.01493) [![Travis build status](https://travis-ci.org/USCbiostats/slurmR.svg?branch=master)](https://travis-ci.org/USCbiostats/slurmR) [![codecov](https://codecov.io/gh/USCbiostats/slurmR/branch/master/graph/badge.svg)](https://codecov.io/gh/USCbiostats/slurmR) [![lifecycle](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://www.tidyverse.org/lifecycle/#experimental) [![CRAN status](https://www.r-pkg.org/badges/version/slurmR)](https://CRAN.R-project.org/package=slurmR)
...
5.  Provide a backend for the [parallel](https://stat.ethz.ch/R-manual/R-devel/library/parallel/doc/parallel.pdf) package, providing an out-of-the-box method for creating Socket cluster objects for multi-node operations. (See the examples below on how this can be used with other R packages)
...
#  sbatch --job-name=slurmR-job-67c1320b1f9 /auto/rcf-40/vegayon/slurmR/slurmR-job-67c1320b1f9/01-bash.sh
...
ans <- Slurm_lapply(x, mean, plan = "none")
#  --------------------------------------------------------------------------------
#  [VERBOSE MODE ON] The R script that will be used is located at: /auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/00-rscript.r and has the following contents:
#  --------------------------------------------------------------------------------
...
#  JOB_PATH         <- "/auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/"
#  INDICES          <- readRDS("/auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/INDICES.rds")
#  X                <- readRDS(sprintf("/auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/X_%04d.rds", ARRAY_ID))
#  FUN              <- readRDS("/auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/FUN.rds")
#  mc.cores         <- readRDS("/auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/mc.cores.rds")
#  seeds            <- readRDS("/auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/seeds.rds")
...
#      mc.cores         = mc.cores
#  )
#  saveRDS(ans, sprintf("/auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
#  --------------------------------------------------------------------------------
#  The bash file that will be used is located at: /auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/01-bash.sh and has the following contents:
#  --------------------------------------------------------------------------------
#  #!/bin/sh
#  #SBATCH --job-name=slurmR-job-67c130b9263d
#  #SBATCH --output=/auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/02-output-%A-%a.out
#  #SBATCH --array=1-2
#  #SBATCH --ntasks=1
#  #SBATCH --cpus-per-task=1
#  export OMP_NUM_THREADS=1
#  /usr/usc/R/3.5.0/lib64/R/bin/Rscript --vanilla /auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/00-rscript.r
#  --------------------------------------------------------------------------------
#  EOF
#  --------------------------------------------------------------------------------
#  Warning: [submit = FALSE] The job hasn't been submitted yet. Use sbatch() to submit the job, or you can submit it via command line using the following:
#  sbatch --job-name=slurmR-job-67c130b9263d /auto/rcf-40/vegayon/slurmR/slurmR-job-67c130b9263d/01-bash.sh
Slurm_clean(ans) # Cleaning after you
```
...
[2] Functionality similar to the apply family in base R.
    ...
    <tr>
        <td colspan="8" height="17" align="left" valign="middle" bgcolor="#FFFFFF">
[3] Number of directed/recursive dependencies. As reported in <a href="https://tinyverse.netlify.com">https://tinyverse.netlify.com/</a> (June 4th, 2019)
</td>
        </tr>
</tbody></table>
...
-   Princeton [Princeton Research Computing](https://researchcomputing.princeton.edu/education/online-tutorials/getting-started/introducing-slurm)

-   Harvard [FAS](https://www.rc.fas.harvard.edu/resources/quickstart-guide/), [HMS research computing](https://rc.hms.harvard.edu/)

-   UCSan Diego [WM Keck Lab for Integrated Biology](https://keck2.ucsd.edu/dokuwiki/doku.php/wiki:slurm)

-   Stanford [Sherlock](https://www.sherlock.stanford.edu/docs/overview/introduction/), [SCG Informatics Cluster](https://login.scg.stanford.edu/tutorials/job_scripts/)

-   Berkeley [Research IT](http://research-it.berkeley.edu/services/high-performance-computing/running-your-jobs)

-   University of Utah [CHPC](https://www.chpc.utah.edu/documentation/software/slurm.php)

-   University of Michigan [Biostatistics cluster](https://sph.umich.edu/biostat/computing/cluster/slurm.html)

-   The University of Kansas [Center for Research Computing](https://crc.ku.edu/hpc/how-to)

-   University of Cambridge [MRC Biostatistics Unit](https://www.mrc-bsu.cam.ac.uk/research-and-development/high-performance-computing-at-the-bsu/)
