...
[![DOI](http://joss.theoj.org/papers/10.21105/joss.01493/status.svg)](https://doi.org/10.21105/joss.01493) [![Travis build status](https://travis-ci.org/USCbiostats/slurmR.svg?branch=master)](https://travis-ci.org/USCbiostats/slurmR) [![codecov](https://codecov.io/gh/USCbiostats/slurmR/branch/master/graph/badge.svg)](https://codecov.io/gh/USCbiostats/slurmR) [![CRAN status](https://www.r-pkg.org/badges/version/slurmR)](https://CRAN.R-project.org/package=slurmR) [![CRAN status](https://www.r-pkg.org/badges/version/slurmR)](https://cran.r-project.org/package=slurmR) [![CRAN downloads](http://cranlogs.r-pkg.org/badges/grand-total/slurmR)](https://cran.r-project.org/package=slurmR)
...
#  sbatch --job-name=slurmr-job-75da180ae335 /auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/01-bash.sh
...
ans <- Slurm_lapply(x, mean, plan = "none")
#  --------------------------------------------------------------------------------
#  [VERBOSE MODE ON] The R script that will be used is located at: /auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/00-rscript.r and has the following contents:
#  --------------------------------------------------------------------------------
...
#  JOB_NAME  <- "slurmr-job-75da180ae335"
...
#  tryCatch_and_quit(INDICES          <- readRDS("/auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/INDICES.rds"))
#  tryCatch_and_quit(X                <- readRDS(sprintf("/auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/X_%04d.rds", ARRAY_ID)))
#  tryCatch_and_quit(FUN              <- readRDS("/auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/FUN.rds"))
#  tryCatch_and_quit(mc.cores         <- readRDS("/auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/mc.cores.rds"))
#  tryCatch_and_quit(seeds            <- readRDS("/auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/seeds.rds"))
...
#      mc.cores         = mc.cores
#  )
#  saveRDS(ans, sprintf("/auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
#  --------------------------------------------------------------------------------
#  The bash file that will be used is located at: /auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/01-bash.sh and has the following contents:
#  --------------------------------------------------------------------------------
#  #!/bin/sh
#  #SBATCH --job-name=slurmr-job-75da180ae335
#  #SBATCH --output=/auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/02-output-%A-%a.out
#  #SBATCH --array=1-2
#  #SBATCH --job-name=slurmr-job-75da180ae335
#  #SBATCH --cpus-per-task=1
#  #SBATCH --ntasks=1
#  export OMP_NUM_THREADS=1
#  /usr/usc/R/3.6.0/lib64/R/bin/Rscript  /auto/rcf-40/vegayon/slurmR/slurmr-job-75da180ae335/00-rscript.r
#  --------------------------------------------------------------------------------
#  EOF
#  --------------------------------------------------------------------------------
#  Warning: [submit = FALSE] The job hasn't been submitted yet. Use sbatch() to submit the job, or you can submit it via command line using the following:
