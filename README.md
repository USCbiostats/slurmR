...
4.  Is specialized on Slurm, meaning more flexibility (no need to modify
    template files) and debugging tools (e.g., job resubmission).
...
And the actual R package:
  ...
  Vega Yon G, Marjoram P (????). _slurmR: A Lightweight Wrapper for
...
#  Warning in normalizePath(file.path(tmp_path, job_name)): path[1]="/home/
#  george/Documents/development/slurmR/slurmr-job-27165393bf6bf": No such file or
#  directory
...
#  sbatch --job-name=slurmr-job-27165393bf6bf /home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/01-bash.sh
...
#  directory
#  --------------------------------------------------------------------------------
#  [VERBOSE MODE ON] The R script that will be used is located at: /home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/00-rscript.r and has the following contents:
#  --------------------------------------------------------------------------------
...
#  JOB_NAME  <- "slurmr-job-27165393bf6bf"
#  
...
#  tcq({
#    INDICES <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/INDICES.rds")
#  })
#  tcq({
#    X <- readRDS(sprintf("/home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/X_%04d.rds", ARRAY_ID))
#  })
#  tcq({
#    FUN <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/FUN.rds")
#  })
#  tcq({
#    mc.cores <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/mc.cores.rds")
#  })
#  tcq({
#    seeds <- readRDS("/home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/seeds.rds")
#  })
...
#  )
#  })
#  saveRDS(ans, sprintf("/home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
#  message("[slurmR info] job-status: OK.\n")
#  --------------------------------------------------------------------------------
#  The bash file that will be used is located at: /home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/01-bash.sh and has the following contents:
#  --------------------------------------------------------------------------------
#  #!/bin/sh
#  #SBATCH --job-name=slurmr-job-27165393bf6bf
#  #SBATCH --output=/home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/02-output-%A-%a.out
#  #SBATCH --array=1-2
#  #SBATCH --job-name=slurmr-job-27165393bf6bf
#  #SBATCH --cpus-per-task=1
#  #SBATCH --ntasks=1
#  /usr/lib/R/bin/Rscript  /home/george/Documents/development/slurmR/slurmr-job-27165393bf6bf/00-rscript.r
#  --------------------------------------------------------------------------------
#  EOF
#  --------------------------------------------------------------------------------
#  Warning: [submit = FALSE] The job hasn't been submitted yet. Use sbatch() to submit the job, or you can submit it via command line using the following:
...
object. This feature allows using `slurmR` with other R packages that
support working with `SOCKcluster` class objects. Here are some examples
...
| UC Berkeley Open Computing Facility                    | US      | [link](https://www.ocf.berkeley.edu/docs/services/hpc/slurm/)                |
